# Executed on interactive shells
## Aliases
source $HOME/.aliases
...
### Command Completion
# Load and run command completion
autoload -U compinit
compinit -i
...
### Key Bindings
autoload zkbd
source ~/.zkbd/$TERM.tmp # may be different - check where zkbd saved the configuration:
...
export GREP_COLOR='1;32' # Color grep results - Examples: http://rubyurl.com/ZXv
###
